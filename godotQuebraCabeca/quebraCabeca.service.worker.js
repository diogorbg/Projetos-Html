...
/** @type {string} */
const CACHE_VERSION = '1761530133|13153879343';
/** @type {string} */
const CACHE_PREFIX = 'Quebra Cabeça-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'quebraCabeca.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["quebraCabeca.html","quebraCabeca.js","quebraCabeca.offline.html","quebraCabeca.icon.png","quebraCabeca.apple-touch-icon.png","quebraCabeca.audio.worklet.js","quebraCabeca.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["quebraCabeca.wasm","quebraCabeca.pck"];
